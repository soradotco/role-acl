...
var getValueByPath = require('../src').getValueByPath;
function type(o) {
...
describe('Test Suite: Access Control', function () {
    ...
    it('should have valid basic custom condition example in the docs', function () {
        ...
        var greaterOrEqual = function (context, args) {
    ...
    it('should have valid no arguments custom condition example in the docs', function () {
        var myConditions = {
            isArticleOwner: function (context) {
        ...
        expect(ac.can('user').context({ loginUserId: 1, articleOwnerId: 1 })
            .execute('update').sync().on('article').granted).toBe(true);
    });
    it('should have valid async custom condition example in the docs', function () {
        return __awaiter(this, void 0, void 0, function () {
            var asyncCheckResourceForUser, myConditions, ac, _a, _b;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        asyncCheckResourceForUser = function (resource, loginUserId, record) { return new Promise(function (resolve) {
                            resolve(resource === 'article' && loginUserId === 1 && record.id === 10);
                        }); };
                        myConditions = {
                            isResourceOwner: function (context, args) { return __awaiter(_this, void 0, void 0, function () {
                                var resource, loginUserId;
                                return __generator(this, function (_a) {
                                    resource = (args || {}).resource;
                                    loginUserId = context.loginUserId;
                                    return [2 /*return*/, asyncCheckResourceForUser(resource, loginUserId, context[resource])];
                                });
                            }); }
                        };
                        ac = new AccessControl();
                        ...
                        ac.grant("user")
                            ...
                            .on('article');
                        _a = expect;
                        return [4 /*yield*/, ac.can('user').context({ loginUserId: 1, article: { id: 10 } })
                                .execute('update').on('article')];
                    case 1:
                        _a.apply(void 0, [(_c.sent())
                                .granted]).toBe(true);
                        _b = expect;
                        return [4 /*yield*/, ac.can('user').context({ loginUserId: 2, article: { id: 10 } })
                                .execute('update').on('article')];
                    case 2:
    ...
    it('should have valid serialization and batch register custom conditions example in the docs', function () {
        return __awaiter(this, void 0, void 0, function () {
            var myPolicy, ac, _a, _b, _c;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        myPolicy = {
                            ...
                            myConditions: {
                                isResourceOwner: function (_a, _b) {
                                    var user = _a.user, record = _a.record;
                                    var resource = _b.resource;
                        ...
                        ac = new AccessControl(myPolicy.grants, myPolicy.myConditions);
                        // Use it
                        _a = expect;
                        return [4 /*yield*/, ac.can('user').context({ user: { id: 1 }, record: { id: 1 } })
                                .execute('update').on('profile')];
                    case 1:
                        // Use it
                        _a.apply(void 0, [(_d.sent()).granted]).toBe(true); // granted === true
                        _b = expect;
                        return [4 /*yield*/, ac.can('user').context({ user: { id: 1 }, record: { id: 1 } })
                                .execute('delete').on('article')];
                    case 2:
                        _b.apply(void 0, [(_d.sent()).granted]).toBe(false); // granted === false
                        _c = expect;
                        return [4 /*yield*/, ac.can('user').context({ user: { id: 1 }, record: { id: 2 } })
                                .execute('delete').on('article')];
                    case 3:
                        _c.apply(void 0, [(_d.sent()).granted]).toBe(true); // granted === true
                        return [2 /*return*/];
                }
            });
        });
    });
    it('should have valid mix custom and core conditions and use JSON path helper example in the docs', function () {
        return __awaiter(this, void 0, void 0, function () {
            var myPolicy, ac, _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        myPolicy = {
                            ...
                            myConditions: {
                                categoryMatcher: function (context, _a) {
                                    var type = _a.type;
                                ...
                                isResourceOwner: function (context, _a) {
                        ...
                        // Use it
                        _a = expect;
                        return [4 /*yield*/, ac.can('editor/news').context({ user: { id: 1 }, article: { owner: 1 }, category: { type: 'news' } })
                                .execute('approve').on('article')];
                    case 1:
                        // Use it
                        _a.apply(void 0, [(_d.sent()).granted]).toBe(true); // granted === true
                        _b = expect;
                        return [4 /*yield*/, ac.can('editor/news').context({ user: { id: 1 }, article: { owner: 2 }, category: { type: 'news' } })
                                .execute('approve').on('article')];
                    case 2:
                        _b.apply(void 0, [(_d.sent()).granted]).toBe(false); // granted === false
                        _c = expect;
                        return [4 /*yield*/, ac.can('editor/news').context({ user: { id: 1 }, article: { owner: 1 }, category: { type: 'tutorials' } })
                                .execute('approve').on('article')];
                    case 3:
                        _c.apply(void 0, [(_d.sent()).granted]).toBe(false); // granted === false
                        return [2 /*return*/];
                }
            });
        });
    ...
    it('should grant access with list contains condition on single value and check permissions - json path', function () {
        return __awaiter(this, void 0, void 0, function () {
            var ac, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _a = expect;
                        return [4 /*yield*/, ac.can('user').context({ user: { tags: ['sports'] }, instance: { type: 'sports' } }).execute('create').on('article')];
                    case 1:
                        _a.apply(void 0, [(_c.sent()).granted]).toEqual(true);
                        _b = expect;
                        return [4 /*yield*/, ac.can('user').context({ user: { tags: ['politics'] } }).execute('create').on('article')];
                    case 2:
                        _b.apply(void 0, [(_c.sent()).granted]).toEqual(false);
                        return [2 /*return*/];
                }
